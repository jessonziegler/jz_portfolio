  ...
  const handleProjectsFilter = (item) => {
    ...
    setTimeout(() => {
      ...
      if (item === "All") {
        ...
        setFilterProjects(works.filter((work) => work.tags.includes(item)));
      }
    }, 500);
  };
        ...
        {filterProjects.map((work, index) => (
          <div className="app__work-item app__flex" key={index}>
            <div className="app__work-img app__flex">
              ...
              >
                <a href={work.projectLink} target="_self" rel="noreferrer">
                  <motion.div
                ...
                <a href={work.codeLink} target="_self" rel="noreferrer">
                  <motion.div
                    whileInView={{ scale: [0, 1] }}
                    whileHover={{ scale: [1, 0.9] }}
                    transition={{ duration: 0.25 }}
